...
//  2.父类构造函数是否有隐式的 super() :  有的,构造函数默认第一行都是super(); 父类的父类是java中的对象Object;

// 总结:
// 类中的构造函数默认第一行都有隐式的super()语句,在访问父类的构造函数
// 所有父类的构造函数既可以给自己的对象初始话,也可以给自己的子类对象初始化
// 如果默认的的隐式super的语句没有对应的构造函数,必须在构造函数中通过this() 或者super的形式明确调用了构造函数;
